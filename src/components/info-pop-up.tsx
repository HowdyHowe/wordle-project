  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center z-10">
      ...
      <div className={`relative flex flex-col items-center justify-center w-[300px] h-[450px] rounded-md z-20 px-4 lg:w-[400px] ${darkMode ? "bg-[#2c2c2c]" : "bg-white"}`}>
        <div className="flex flex-col items-center justify-start text-center w-full h-full mt-10 mb-3 overflow-y-scroll scrollbar-thin scrollbar-thumb-[#dfe2ff] scrollbar-track-transparent">
            <h2 className="text-xl font-bold mb-4 bg-[#dfe2ff] text-black w-full rounded-md">Cara Bermain Wordle</h2>
            <p className="font-bold text-lg">Tebak Kata</p>
            <p className="font-fredokalight mb-2 text-xs">Kamu harus menebak kata dalam 6 percobaan, ketik kata lalu tekan Enter.</p>
            <p className="font-bold text-lg mt-2">Warna Petunjuk</p>
            ...
            <div className="flex flex-row justify-evenly w-full">
                <div className="box-correct-dummy">J</div>
                <div className="box-correct-dummy">E</div>
                <div className="box-semi-correct-dummy">J</div>
                <div className="box-incorrect-dummy">A</div>
                <div className="box-incorrect-dummy">K</div>
            </div>
            <div className="flex items-center justify-evenly w-full">
                <RxChevronDown size={30} className={`${darkMode ? "bg-[#2c2c2c]" : "bg-white"}`}/>
                <RxChevronDown size={30} className={`mx-8 lg:mx-[50px] ${darkMode ? "bg-[#2c2c2c]" : "bg-white"}`}/>
                <RxChevronDown size={30} className={`${darkMode ? "bg-[#2c2c2c]" : "bg-white"}`}/>
            </div>
            <div className="flex items-center justify-evenly w-full">
            ...
            <p className="font-bold text-lg mt-2">Menang & Kalah</p>
